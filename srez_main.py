...
tf.app.flags.DEFINE_integer('downscale', 4,
...
tf.app.flags.DEFINE_float('gpu_fraction', 0.85,
...
tf.app.flags.DEFINE_bool('mnist', False,
                         "Set True for MNIST images or other very small images.")

tf.app.flags.DEFINE_bool('reflect_images', True,
                         "Whether to reflect the images (set False for letters and digits)")

tf.app.flags.DEFINE_bool('specific_test', False,
                         "Set to True if you want to test specific images")                         
...
def prepare_test_dirs(): 
    ...
    filenames = sorted(filenames)
    filenames = [os.path.join(FLAGS.test_dataset, f) for f in filenames]
